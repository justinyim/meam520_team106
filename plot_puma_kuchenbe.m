...
% kinematics part of Project 1 in MEAM 520 at the University of Pennsylvania.
...
[points_to_plot, x60, y60, z60] = puma_fk_kuchenbe(theta1, theta2, theta3, theta4, theta5, theta6);
...
% Put desired origin position in a column vector.
odes = [x ; y ; z];
...
if (nargin == 16)
    ...
    set(hx06, 'xdata', x60(1,:), 'ydata', x60(2,:), 'zdata', x60(3,:));
    set(hy06, 'xdata', y60(1,:), 'ydata', y60(2,:), 'zdata', y60(3,:));
    set(hz06, 'xdata', z60(1,:), 'ydata', z60(2,:), 'zdata', z60(3,:));
    ...
    hx06 = plot3(x60(1,:), x60(2,:), x60(3,:), 'w:', 'linewidth',2);
    hy06 = plot3(y60(1,:), y60(2,:), y60(3,:), 'w--', 'linewidth',2);
    hz06 = plot3(z60(1,:), z60(2,:), z60(3,:), 'w-', 'linewidth',2);
